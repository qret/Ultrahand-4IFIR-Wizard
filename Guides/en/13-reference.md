...
"Values" is the length of the very list that opens on screen. A field's name dictionary is wider: the tuner can name a value some other package wrote, but it does not offer such a value for picking, and it is not counted here.
...
| Advanced → CPU → Min Voltage | `CPU Minimal Voltage` | both | 53 | Auto — eBAMATIC, Auto — Eco ST1 — Default … 750 mV |
...
| Advanced → GPU → vMin Offset | `pMeh 19 vMINetune ST` | both | 15 | +20 mV, +15 mV … -50 mV |
| Advanced → GPU → vMin Offset (max RAM) | `pMeh 21 gVMINDick` | both | 15 | +25 mV, +20 mV … -45 mV |
...
| Advanced → Micro-Enhance Logic → pMeh 0-22 → pMeh 19 vMINetune ST | `pMeh 19 vMINetune ST` | both | 15 | +20 mV, +15 mV … -50 mV |
| Advanced → Micro-Enhance Logic → pMeh 0-22 → pMeh 20 rVDDick | `pMeh 20 rVDDick` | both | 7 | 0, 1 … 6 |
| Advanced → Micro-Enhance Logic → pMeh 0-22 → pMeh 21 gVMINDick | `pMeh 21 gVMINDick` | both | 15 | +25 mV, +20 mV … -45 mV |
