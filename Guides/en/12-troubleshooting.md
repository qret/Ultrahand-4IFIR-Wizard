<!-- i18n: source=Guides/ru/12-troubleshooting.md sha=5920a2a43efb self=2c8eb25ec6af -->
...
> [!TIP]
> **Was a GPU vMin offset the last thing changed?** In KipTool type `1` for `pMeh 19` and
> `2` for `pMeh 21` — those are their factory values. Type both even if only one was
> changed: the fields sit next to each other and are easy to mix up.
